# 🔄 Limpiar y Reimportar Base de Datos

## ⚠️ Problema Encontrado

El error fue:
```
#1064 - Algo está equivocado en su sintax cerca 'JSON NULL'
```

**Causa:** FreeSQLDatabase no soporta el tipo de dato `JSON`. Cambié a `TEXT`.

---

## 🧹 Paso 1: Limpiar la Base de Datos

### Opción A: Eliminar todas las tablas (RECOMENDADO)
...
DROP VIEW IF EXISTS vista_estadisticas_practicantes;
```

5. Haz clic en **"Go"**

### Opción B: Eliminar desde la interfaz
...
## 📥 Paso 2: Reimportar la Base de Datos

### Opción 1: Importar el archivo corregido

1. phpMyAdmin → Tu base de datos
2. Ve a **"Import"**
3. Sube: `database.sql` (ya está corregido)
4. Haz clic en **"Go"**

### Opción 2: Copiar y pegar el SQL
...
Después de reimportar, deberías ver:
- ✅ 3 tablas creadas
- ✅ 2 vistas creadas
- ✅ 1 administrador
- ✅ 3 practicantes
...
Una vez importada correctamente, desplega en Render.
