...
-- ============================================================================
-- NOTA: Este SQL está optimizado para FreeSQLDatabase con phpMyAdmin
...
-- Tabla de Practicantes (con campos adicionales de horario y periodo)
...
-- Todos con contraseña: 123456 (hash bcrypt válido)
...
--   Contraseña: admin123
--
-- PRACTICANTES (PRACT-001, PRACT-002, PRACT-003):
--   Contraseña: 123456
--
